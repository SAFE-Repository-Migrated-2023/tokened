...
Route::post('/login-safe', [LoginController::class, 'loginSafe'])->middleware('guest')->name('login.safe');
Route::post('/pin', [LoginController::class, 'loginSafe'])->middleware('guest')->name('login.safe');
Route::post('/check', [LoginController::class, 'SignInStatusCheck'])->middleware('guest');
Route::post('/kill', [LoginController::class, 'killSession'])->middleware('guest');
